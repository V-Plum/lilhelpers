...
**Праві панелі — про сам знімок, а не про позначки.** З 4.6.0 їх дві, і кожна має
свою вкладку-значок у смузі праворуч. Відкрита може бути лише одна: клік по іншому
значку перемикає панель, клік по відкритій згортає її. При відкритті редактора
обидві згорнуті.
...
(`LHVEND` і зсув блока) дає знайти хвіст без розбору MP4. Перевірка —
...
### Кадрувати й зменшити відео (з 4.7.0)
