...
Клік і тягнення по таймлайну перемотують точно на кадр; колесо над ним —
...
Далі за планом: обрізати й вирізати фрагмент, позначки поверх відео, запис
вікна «слідом за вікном», курсор і підсвічування кліків, звук і лог DevTools із
Chrome, синхронний із відео.
...
- Запис відео експериментальний. Поки що без звуку й без курсора; вікно
  записується як ділянка, де воно було на старті. У редакторі відео поки лише
  перегляд — обрізання, позначки й збереження будуть наступними етапами.
