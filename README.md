...
Інструменти: прямокутник, еліпс, стрілка, лінія, олівець, текст, приховування,
...
пунктирними чи штрихпунктирними; у стрілки окремо обирається форма наконечника
(трикутник, «пташка», кружечок), його розмір і те, на яких кінцях він стоїть.
Розмір наконечника заданий у пікселях знімка, а не в товщинах пера, тож великий
наконечник лишається великим і на тонкій лінії.
...
тоном. Зміна розміру зображення веде позначки за собою координатами, але
...
об'єктом**, а тло навколо лишається прозорим — його можна залишити так або
підкласти прямокутник потрібного кольору. Обидві дії — один крок `Ctrl+Z`,
разом із пікселями.
