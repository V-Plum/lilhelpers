...
⚠ **Поширення під адміністратором може не працювати.** Програма запускається з
правами адміністратора (це потрібно для перехоплення CapsLock), а меню поширення
й самі приймачі — ні, і дістати до неї вони не завжди можуть. Мовчки це більше
не відбувається: якщо Windows відкрила меню, але даних так і не спитала,
програма каже про це прямо. Надійні шляхи в такому разі ті самі — «Копіювати»
або «Експорт».
