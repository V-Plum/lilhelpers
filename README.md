...
Інструменти: прямокутник, овал, стрілка, лінія, олівець, текст. Для кожного —
колір, три товщини й прозорість, для замкнених фігур ще й заливка. `Shift`
...
Що поки не зроблено і буде далі: маркер, приховування ділянки, лічильник
кроків, штампи, кадрування, ручна правка експозиції та гами, відкриття
збережених файлів.
...
- Редактор знімків експериментальний: маркер, приховування ділянки, лічильник
  і штампи ще попереду.
