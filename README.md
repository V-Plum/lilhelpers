...
маркер. Для кожного — колір, три товщини й прозорість, для замкнених фігур ще
й заливка. `Shift`
...
Що поки не зроблено і буде далі: лічильник кроків, штампи, кадрування, ручна
правка експозиції та гами.
...
- Редактор знімків експериментальний: лічильник кроків і штампи ще попереду.
