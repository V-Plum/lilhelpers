...
системним програвачем. Файл пишеться як `.mp4.part` і стає записом лише
...
Далі за планом: запис вікна «слідом за вікном», курсор і підсвічування кліків,
звук, редактор (обрізати, вирізати фрагмент, позначки поверх відео) і лог
DevTools із Chrome, синхронний із відео.
...
- Запис відео експериментальний. Поки що без звуку, без курсора й без
  редактора; вікно записується як ділянка, де воно було на старті. Усе це —
  наступні етапи.
