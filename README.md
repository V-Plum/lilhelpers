...
- **Запис відео з екрана** — `Alt+Shift+5` записує ділянку, вікно (і йде за
  ...
  синхронний із відео, і звіт для розробника (відео + лог) одним файлом. З 4.0.0.
...
- Поки розширення під'єднане до вкладки, браузер показує смугу «розширення
  налагоджує цей браузер» — це обмеження платформи, і вона потрапляє в запис.
...
| `browser-extension/` | розширення Chrome/Edge (лог DevTools, CAPS-83) і переглядач звіту (`report.*`, `viewer.*`, CAPS-84); вшите в exe як ресурси |
