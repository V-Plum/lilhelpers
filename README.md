...
- **Запис відео з екрана** — `Alt+Shift+5` записує ділянку, вікно (і йде за
  ...
  і зберігає все як проєкт `.lhvideo`. ⚠ Експериментально, з 4.0.0.
...
- Запис відео експериментальний. Режим «слідувати за вікном» потребує
...
- Записується монітор, на якому вибрано ділянку; повернутий на 90° монітор
  поки не підтримано.
- Редактор знімків і відео експериментальний: формат і поведінка ще можуть
  змінюватись (старі файли при цьому відкриваються — див. про версії формату).
