...
Інструменти: прямокутник, овал, стрілка, лінія, олівець. Для кожного — колір,
три товщини й прозорість, для замкнених фігур ще й заливка. `Shift` тримає
квадрат, коло й кут, кратний 45°. Інструмент лишається активним після
малювання, щоб поставити кілька позначок поспіль; перемикається на вкладці
«Знімки».

Що поки не зроблено і буде далі: текст, маркер, приховування ділянки,
лічильник кроків, штампи, кадрування, ручна правка експозиції та гами,
...
- Редактор знімків експериментальний: текст, маркер, приховування ділянки,
  лічильник і штампи ще попереду.
