...
прозорості. Форма зразка каже, що це за колір: **кільце** — контур (лінія,
олівець, рамка фігури), **кружок** — колір самої позначки (напис, лічильник,
штамп, маркер), **квадратик** — заливка. Напівпрозорий колір лежить на
...
Клавіатура: **`1`–`8`** — колір із палітри зліва направо, **`Shift+1`–`8`** —
другий колір (заливка, обводка, цифра), **`Shift+0`** — прибрати його. Документи,
...
Групу можна правити цілою: тогл перед кольором вмикає режим, у якому колір,
